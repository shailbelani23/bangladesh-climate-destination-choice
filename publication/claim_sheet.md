...
The national BIHS migrant model transfers to origins omitted entirely from training: the full-choice gain is 0.101 [0.074, 0.128], and the interdistrict gain is 0.107 [0.073, 0.144]. The smaller climate samples do not support the same full-choice transport claim. For BIHS erosion moves, leaving one origin out produces a full-choice gain of -0.016 [-0.086, 0.045] and an interdistrict gain of 0.058 [-0.034, 0.140]. BEMP shows the same directional split. Origin conditions appear to carry more information about staying within a district than about the ranking of other districts after a cross-district move.

## Human illustration

An anonymized BIHS household head reported moving from Faridpur to Manikganj in 2010 after river erosion caused the loss of land or homestead land. Gravity assigned Manikganj 7.0% probability and rank 6 of 64. The GIS model assigned 13.7% and rank 2. This case illustrates the prediction task; it cannot reveal the household's private reasoning or prove that mapped destination attributes caused the move.
